/*
 * Public API Surface of ngx-miniprofiler-overlay
 */

export * from './lib/ngx-miniprofiler-overlay.module';
export * from './lib/services/ngx-miniprofiler-overlay.service';
